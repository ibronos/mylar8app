					  ...
					  <div class="card-body">
						...
						<div class="form-group row">
	 				    ...
	 				    <div class="form-group row">
						    ...
						    <div class="col-sm-5">
						      <input type="text" class="form-control" name="contact_name" id="telephone" placeholder="Contact Name">
						    </div>
						    <div class="col-sm-5">
	 				    ...
	 				    <div class="form-group row">
						    ...
						    <div class="col-sm-4">
						    	<input type="text" class="form-control" name="bank_account_name" id="bank_name" placeholder="Account Name">
						    </div>
						    
						    <div class="col-sm-4">
						      <input type="text" class="form-control" name="bank_number" id="bank_number" placeholder="Bank Number">
						    </div>
						</div>
					  </div>
